...
public class LoginPageLocators {
    ...
    public static final By LOGOUT_FIELD_ID_LOCATOR = By.xpath("//*[text()='Logout']");
    public static final By ERROR_MESSAGE_ID_LOCATOR= By.xpath("//*[text()='You must specify a username to log in.']");
